...
% The data appendix goes here when the calibration lands: one subsection per calibration target,
% with the tables emitted by the data pipeline under a %% GENERATED banner. docs_style.md, section 5.
